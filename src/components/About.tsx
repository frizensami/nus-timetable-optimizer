    ...
    return (
        <Container text textAlign='justified'>
            ...
            I would urge anyone interested to see the modsplanner {"team's"} technical report and work on <a href="https://github.com/raynoldng/nusmods-planner">their GitHub page</a>.
                ...
                <a href="https://github.com/Z3Prover/z3"><strong> Microsoft Z3 SMT (Satisfiability Modulo Theories) solver</strong></a>, an incredible piece of work that 
                ...
                <a href="https://github.com/cpitclaudel/z3.wasm"> the z3.wasm project</a>. The front-end is built using <a href="https://reactjs.org/">React</a>.</p> 
